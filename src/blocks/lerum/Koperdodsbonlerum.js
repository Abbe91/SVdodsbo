...
const Koperdodsbonlerum = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Köper dödsbo Lerum";
  const newsData = useSelector(getNewsData);
  const [content, setContent] = useState({
    metaTitle:
      "Uppköp av dödsbo i Lerum. Vill du sälj ett dödsbo i Lerum? Vi köper hela eller delar av dödsbon till rättvist pris.",
    query: "Uppköp dödsbo Lerum",
    metaContent:
      "Vi köper dödsbo i Lerum. Sälj dödsbo i Lerum till rättvist pris med vår professionella uppköpstjänst. Vi köper hela eller delar av dödsbon i Lerum.",
    query: "Köper dödsbo Lerum",
    formTitle: "Köper dödsbo Lerum",
    subTitle2:
      "Din auktoriserade hanterare av dödsbo, bohag, försäljning, tömning, bortforsling, sanering, flytt, städning och uppköp av dödsbo i Lerum",
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    headline:
      "Vi köper dödsbon i Lerum. Vill du sälj ett dödsbo i Lerum? Vi köper hela eller delar av dödsbon till rättvist pris",
    description:
      "Uppköp av dödsbo i Lerum. Sälj dödsbo i Lerum till rättvist pris med vår professionella uppköpstjänst. Vi köper hela eller delar av dödsbon i Lerum.",
    image:
...
export default Koperdodsbonlerum;
