...
const TommaDodsboKortedala = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "tömma dödsbo Kortedala";
  const newsData = useSelector(getNewsData);
  const [content, setContent] = useState({
    metaTitle: "Tömma dödsbo i Kortedala - Effektiv och pålitlig service!",
    metaContent:
      "Behöver du hjälp med att tömma dödsbo i Kortedala? Vår erfarna personal garanterar en prisvärd, smidig och säker process för att tömma dödsbo i Kortedala.",
    query: "Tömma dödsbo Kortedala",
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    headline: "Tömma dödsbo i Kortedala - Effektiv och pålitlig service!",
    description:
      "Behöver du hjälp med att tömma dödsbo i Kortedala? Vår erfarna personal garanterar en prisvärd, smidig och säker process för att tömma dödsbo i Kortedala.",
    image:
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://alladodsbo.se/tomma-dodsbo-kortedala"
        />
        <meta
          property="og:image"
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/tomma-dodsbo-kortedala"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default TommaDodsboKortedala;
