...
const Varderadodsbokungsbacka = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Värdera dödsbo Kungsbacka";
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    headline: "Värdera dödsbo Kungsbacka. Få rätt pris och snabb hantering",
    description:
      "Värdera dödsbo Kungsbacka - Behöver du hjälp med att värdera dödsbo i Kungsbacka? Vi erbjuder professionell och pålitlig service för en rättvis värdering.",
    image:
    ...
    <div>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/vardera-dodsbo-kungsbacka"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Varderadodsbokungsbacka;
