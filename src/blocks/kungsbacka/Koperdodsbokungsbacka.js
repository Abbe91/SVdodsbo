...
const Koperdodsbokungsbacka = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    metaTitle:
      "Vi köper upp dödsbon i Kungsbacka till ett rättvist pris. Professionell och smidig lösning för avyttring av dödsbon.",
    query: "Uppköp dödsbo Kungsbacka",
    metaContent:
      "Köper dödsbo Kungsbacka. Sälj dödsbo i Kungsbacka till rättvist pris med vår professionella uppköpstjänst. Vi köper hela eller delar av dödsbon i Kungsbacka.",
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/koper-dodsbo-kungsbacka"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
