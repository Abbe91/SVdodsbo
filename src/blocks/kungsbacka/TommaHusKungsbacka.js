...
const TommaHusKungsbacka = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Tömma hus i Kungsbacka";
  ...
  return (
    <div>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/tomma-hus/tomma-hus-kungsbacka"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default TommaHusKungsbacka;
