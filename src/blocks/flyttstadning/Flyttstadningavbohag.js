...
const Flyttstadningavbohag = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Flyttstädning av bohag";
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    headline:
      "Flyttstädning av bohag: Spara tid och pengar med en pålitlig städfirma",
    description:
      "Flyttstädning av bohag. Professionell flyttstädning - Så får du ett skinande rent hem",
    image:
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/flyttstadning-av-bohag"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Flyttstadningavbohag;
