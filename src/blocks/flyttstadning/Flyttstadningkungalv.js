...
const Flyttstadningkungalv = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Flyttstädning i Kungälv";
  ...
  const [content, setContent] = useState({
    ...
    subTitle2:
      "Din auktoriserade hanterare av dödsbo, bohag, uppköp, försäljning, tömning, bortforsling, sanering, flytt och flyttstädning i Kungälv",
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/flyttstadning-i-kungalv"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
