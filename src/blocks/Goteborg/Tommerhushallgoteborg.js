...
const Tommerhushallgoteborg = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Tömmer hushåll Göteborg";
  ...
  const [content, setContent] = useState({
    ...
    subTitle2:
      "Vi tömmer, flyttar och städar hushåll, förråd, kontor och företag i Göteborg, eller helt vanlig flytt, städning eller sanering.",
    ...
    <div>
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/tommer-hushall-goteborg"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Tommerhushallgoteborg;
