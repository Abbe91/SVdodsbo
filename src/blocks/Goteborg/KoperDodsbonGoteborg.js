...
const KoperDodsbonGoteborg = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const newsData = useSelector(getNewsData);
  const [content, setContent] = useState({
    metaTitle: "Vi köper dödsbon i Göteborg - Få snabb och rättvis värdering!",
    metaContent:
      "Köper dödsbon i Göteborg. Behöver du hjälp med att vi köper upp ett dödsbo i Göteborg? Vi garanterar en prisvärd, smidig och säker process.",
    formTitle: "Köper dödsbon i Göteborg",
    subTitle2:
  ...
  const mainquery = "Köper dödsbon i Göteborg";
  const services =
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    headline: "Vi köper dödsbon i Göteborg - Få snabb och rättvis värdering!",
    description:
      "Köper dödsbon i Göteborg. Behöver du hjälp med att vi köper upp ett dödsbo i Göteborg? Vi garanterar en prisvärd, smidig och säker process.",
    image:
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://alladodsbo.se/koper-dodsbon-goteborg"
        />
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/koper-dodsbon-goteborg"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default KoperDodsbonGoteborg;
