...
const Koperdodsbogoteborg = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    ...
    subTitle2:
      "Din auktoriserade hanterare av dödsbo, bohag, röjning, försäljning, tömning, bortforsling, sanering, flytt, städning och uppköp av dödsbo i Göteborg",
    ...
    <div>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/koper-dodsbo-goteborg"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Koperdodsbogoteborg;
