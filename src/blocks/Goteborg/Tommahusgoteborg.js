...
const Tommahusgoteborg = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Tömma hus i Göteborg";
  ...
  const [content, setContent] = useState({
    ...
    metaContent:
      "Behöver du hjälp med att tömma ett hus i Göteborg? Då är vi på Döddsbo Sv det självklara valet. Vi tömmer hus i Göteborg med omnejd.",
    ...
    <div>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/tomma-hus/tomma-hus-goteborg"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Tommahusgoteborg;
