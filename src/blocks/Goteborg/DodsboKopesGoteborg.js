...
const DodsboKopesGoteborg = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const newsData = useSelector(getNewsData);
  const [content, setContent] = useState({
    metaTitle: "Dödsbo köpes Göteborg - Vi köper det snabbt och smidigt!",
    metaContent:
      "Dödsbo köpes Göteborg - Vi köper ditt dödsbo i Göteborg snabbt och smidigt!",
    formTitle: "Dödsbo köpes Göteborg",
    subTitle2:
  ...
  const mainquery = "Dödsbo köpes Göteborg";
  const services =
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    headline: "Dödsbo köpes Göteborg - Vi köper det snabbt och smidigt!",
    description:
      "Dödsbo köpes Göteborg - Vi köper ditt dödsbo i Göteborg snabbt och smidigt!",
    image:
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://alladodsbo.se/dodsbo-kopes-goteborg"
        />
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/dodsbo-kopes-goteborg"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default DodsboKopesGoteborg;
