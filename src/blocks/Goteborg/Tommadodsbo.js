...
const Tommadodsbo = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "tömma dödsbo";
  const newsData = useSelector(getNewsData);
  const [content, setContent] = useState({
    metaTitle: "Tömma dödsbo. Prisvärd och snabb tömning av dödsbon.",
    metaContent: "Tömma dödsbo. Prisvärd och snabb tömning av dödsbon.",
    query: "Tömma dödsbo",
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    headline: "Tömma dödsbo. Prisvärd och snabb tömning av dödsbon.",
    description: "Tömma dödsbo. Prisvärd och snabb tömning av dödsbon.",
    image:
