...
const DodsboUppkopare = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Dödsbo uppköpare";
  const newsData = useSelector(getNewsData);
  const bingNews = useSelector(getBingNews);
  const [content, setContent] = useState({
    metaTitle: "Dödsbo uppköpare. Din auktoriserade dödsbo uppköpare!",
    metaContent: "Dödsbo uppköpare. Din auktoriserade dödsbo uppköpare!",
    query:
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    headline: "Dödsbo uppköpare. Din auktoriserade dödsbo uppköpare!",
    description: "Dödsbo uppköpare. Din auktoriserade dödsbo uppköpare!",
    image:
    ...
    <div>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/dodsbo-uppkopare"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default DodsboUppkopare;
