...
const Varderadodsbohisingen = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "värdera dödsbo Hisingen";
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/vardera-dodsbo-hisingen"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Varderadodsbohisingen;
