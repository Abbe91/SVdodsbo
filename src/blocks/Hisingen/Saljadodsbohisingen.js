...
const Saljadodsbohisingen = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "sälja dödsbo Hisingen";
  ...
  return (
    <div>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/salja-dodsbo-hisingen"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Saljadodsbohisingen;
