...
const Tommerdodsbouddevalla = ({ videoText }) => {
  ...
  const services =
    "uppköp, tömning, bortforsling, sanering, luktsanering, flytt, städning städning och tömning av dödsbo i Uddevalla";
    ...
    <div>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/tommer-dodsbo-uddevalla"
        />
        <meta
          property="og:url"
          content="https://alladodsbo.se/tommer-dodsbo-uddevalla"
        />
        <meta
          property="og:image"
...
export default Tommerdodsbouddevalla;
