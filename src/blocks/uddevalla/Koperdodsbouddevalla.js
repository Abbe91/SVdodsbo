...
const Koperdodsbouddevalla = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    ...
    subTitle2:
      "Din auktoriserade hanterare av dödsbo, bohag, försäljning, tömning, bortforsling, sanering, flytt, städning och uppköp av dödsbo i Uddevalla",
    ...
    <div>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/koper-dodsbo-uddevalla"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Koperdodsbouddevalla;
