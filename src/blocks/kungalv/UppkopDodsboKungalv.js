...
const UppkopDodsboKungalv = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "uppköp dödsbo Kungälv";
  ...
  const services =
    "uppköp, tömning, bortforsling, sanering, luktsanering, flytt, städ, försäljning och uppköp av dödsbo i Kungälv";
    ...
    <div>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/uppkop-dodsbo-kungalv"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default UppkopDodsboKungalv;
