...
const TommaDodsboKungalv = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    ...
    subTitle2:
      "Din auktoriserade hanterare av dödsbo, bohag, uppköp, försäljning, bortforsling, sanering, flytt, städning och tömning av dödsbo i Kungälv",
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://alladodsbo.se/tomma-dodsbo-kungalv"
        />
        <meta
          property="og:image"
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/tomma-dodsbo-kungalv"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default TommaDodsboKungalv;
