...
const VarderaDodsboKungalv = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    ...
    subTitle2:
      "Din auktoriserade hanterare av dödsbo, bohag, uppköp, försäljning, tömning, bortforsling, sanering, flytt, städning och värdering av dödsbo i Kungälv",
    ...
    <div>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/vardera-dodsbo-kungalv"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
