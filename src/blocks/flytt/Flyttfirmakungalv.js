...
const Flyttfirmakungalv = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Flyttfirma Kungälv";
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    headline:
      "Billig flyttfirma Kungälv. Din auktoriserade flyttfirma i Kungälv.",
    description:
      "Billig flyttfirma Kungälv. Din auktoriserade flyttfirma i Kungälv. Vi utför flyttar av lägenheter, flyttar av hus och kontorsflytt i Kungälv.",
    image:
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/flyttfirma/flyttfirma-kungalv"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Flyttfirmakungalv;
