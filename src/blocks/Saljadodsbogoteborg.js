...
const Saljadodsbogoteborg = ({ videoText }) => {
  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://alladodsbo.se/salja-dodsbo-goteborg"
        />
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/salja-dodsbo-goteborg"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Saljadodsbogoteborg;
