...
const Varderadodsbogoteborg = ({ videoText }) => {
  ...
  const services =
    "uppköp, tömning, bortforsling, sanering, luktsanering, flytt, städ, försäljning av dödsbo och bohag i Göteborg";
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://alladodsbo.se/vardera-dodsbo-goteborg"
        />
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/vardera-dodsbo-goteborg"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Varderadodsbogoteborg;
