...
const Saljadodsbopartille = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "sälja dödsbo Partille";
  ...
  const services =
    "uppköp, tömning, bortforsling, sanering, luktsanering, flytt, städ och försäljning av dödsbo i Partille";
...
export default Saljadodsbopartille;
