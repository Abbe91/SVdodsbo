...
const Kopadodsbopartille = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "köper dödsbo Partille";
  ...
  const services =
    "tömning, bortforsling, sanering, flytt, städ, försäljning, och uppköp av dödsbo i Partille";
...
export default Kopadodsbopartille;
