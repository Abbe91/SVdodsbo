...
const Uppkopdodsbopartille = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    metaTitle: "Vi köper upp dödsbon i Partille. Bra betalt för ditt dödsbo!",
    query: "Uppköp dödsbo Partille",
    metaContent:
      "Vi köper upp dödsbon i Partille. Sälj dödsbo i Partille till rättvist pris med vår professionella uppköpstjänst. Vi köper hela eller delar av dödsbon i Partille.",
    query: "Uppköp dödsbo Partille",
  ...
  return (
    <div>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/uppkop-dodsbo-partille"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
