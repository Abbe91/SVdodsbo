...
const Dodsbofirmaboras = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Dödsbo firma Borås";
  const newsData = useSelector(getNewsData);
  const bingNews = useSelector(getBingNews);
  const [content, setContent] = useState({
    metaTitle:
      "Dödsbo firma Borås. Din auktoriserade dödsbo firma, bohag, uppköp, försäljning, tömning, bortforsling, sanering, flytt och städning av dödsbo i Borås",
    metaContent:
      "Dödsbo firma Borås. Din auktoriserade dödsbo firma, bohag, uppköp, försäljning, tömning, bortforsling, sanering, flytt och städning av dödsbo i Borås",
    query: "Dödsbo firma Borås",
  ...
  const services =
    "uppköp, tömning, bortforsling, sanering, luktsanering, flytt, städning och försäljning av dödsbo i Borås";
...
export default Dodsbofirmaboras;
