...
const Varderadodsboboras = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Värdera dödsbo Borås";
  ...
  const [content, setContent] = useState({
    ...
    subTitle2:
      "Din auktoriserade hanterare av dödsbo, uppköp, försäljning, tömning, bortforsling, sanering, flytt, städning och värdering av dödsbo i Borås",
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/vardera-dodsbo-boras"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
