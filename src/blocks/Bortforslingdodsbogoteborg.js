...
const Bortforslingdodsbogoteborg = ({ videoText }) => {
  ...
  const services =
    "tömning, bortforsling, sanering, flytt, städning, försäljning och bortforsling av dödsbo i Göteborg";
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://alladodsbo.se/bortforsling-dodsbo-goteborg"
        />
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://alladodsbo.se/bortforsling-dodsbo-goteborg"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Bortforslingdodsbogoteborg;
