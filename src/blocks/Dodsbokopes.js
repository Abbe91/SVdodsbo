...
const Dodsbokopes = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    metaTitle: "Dödsbo köpes - Få snabb och rättvis hantering | Döddsbo Sv",
    metaContent:
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    headline:
      "Dödsbo Köpes. Döddsbo Sv vi hjälper dig med städning, flytt, tömning, bortforsling, värdering och uppköp av dödsbo och hushåll samt återvinning och avfallshantering",
    description:
      "Dödsbo köpes. Behöver du hjälp med flytt, städning, tömning eller uppköp av dödsbo? Välkommen till vår Döddsbo Sv där vi erbjuder allt från bortforsling och värdering till uppköp av dödsbo och hushåll. Vi tar hand om både små och stora projekt, från kontor och lägenheter till fastigheter och hus. Kontakta oss idag för en smidig och stressfri lösning. Vi hjälper även till med återvinning och avfallshantering",
    image:
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/dodsbo-kopes"
          hrefLang="sv"
        />
      </Helmet>
      <div className="Nav">
