...
const Bortforslingdodsbomolndal = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Bortforsling dödsbo Mölndal";
  ...
  const services =
    "uppköp, tömning, bortforsling, sanering, luktsanering, flytt, städ, försäljning och bortforsling av dödsbo i Mölndal";
  ...
  return (
    <div>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/bortforsling-dodsbo-molndal"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Bortforslingdodsbomolndal;
