...
const Bortforslingdodsbofrolunda = ({ videoText }) => {
  ...
  const services =
    "uppköp, tömning, sanering, luktsanering, flytt, städning, försäljning och bortforsling av dödsbo i Frölunda ";
...
export default Bortforslingdodsbofrolunda;
