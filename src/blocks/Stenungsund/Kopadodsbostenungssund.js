...
const Kopadodsbostenungssund = ({ videoText }) => {
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    headline:
      "Vi köper upp dödsbon i Stenungsund. Vill du sälj ett dödsbo i Stenungsund? Vi köper hela eller delar av dödsbon till rättvist pris",
    description:
      "Vi köper upp dödsbon i Stenungsund. Sälj dödsbo i Stenungsund till rättvist pris med vår professionella uppköpstjänst. Vi köper hela eller delar av dödsbon i Stenungsund.",
    image:
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/kopa-dodsbo-stenungsund"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Kopadodsbostenungssund;
