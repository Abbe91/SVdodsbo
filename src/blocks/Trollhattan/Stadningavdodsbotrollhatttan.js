...
const Stadningavdodsbotrollhatttan = ({ videoText }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const mainquery = "Städning av dödsbo Trollhättan";
  ...
  const services =
    "uppköp, tömning, bortforsling, sanering, luktsanering, flytt, försäljning, och städning av dödsbo i Trollhättan";
  ...
  return (
    <div>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/stadning-av-dodsbo-trollhattan"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Stadningavdodsbotrollhatttan;
