...
const Dodsbokopestrollhattan = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    ...
    query: "Uppköp dödsbo Trollhättan",
    metaContent:
  ...
  const services =
    "tömning, bortforsling, sanering, luktsanering, flytt, städning, försäljning, och uppköp av dödsbo i Trollhättan";
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://alladodsbo.se/dodsbo-kopes-trollhattan"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
...
export default Dodsbokopestrollhattan;
