...
const Bortforslingdodsbo = ({ videoText }) => {
  ...
  const services =
    "uppköp, tömning, sanering, luktsanering, flytt, städning, försäljning, värdering och bortforsling av dödsbo.";
...
export default Bortforslingdodsbo;
