  ...
  return (
    <>
      <div className="footer">
        <div>
          <h3 style={{ marginBottom: "0.7rem" }}>Döddsbo Sv</h3>
        ...
        >
          ...
          >
            ...
            dig en trygg och ren miljö. Vi erbjuder också värdering av dödsbon
            och köper upp lösöre för att underlätta processen för dig. Vårt team
            av experter är alltid redo att hjälpa till med att skapa en smidig
            och stressfri lösning för alla dina behov. Kontakta oss idag för mer
            information.
          </p>
        </div>
