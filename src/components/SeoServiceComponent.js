...
const services = [
  {
    ...
    path: "tomma-bohag",
    text: "Vi tömmer lägenheteter, hus, dödsbon, förråd och kontor. Döddsbo Sv tar hand om hela bohag, dödsbo och hushåll, även delar av hem om någon flyttat till ett serviceboende eller liknade. Behöver du hjälp med att tömma ett hus, lägenhet, dödsbo eller kontor i Göteborg? Då är vi på Döddsbo Sv det självklara valet.",
    icon: <HomeWorkIcon />,
  },
  {
